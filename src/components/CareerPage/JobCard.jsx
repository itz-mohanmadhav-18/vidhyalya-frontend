...
const JobCard = ({ title, description, salary, experience , openContactForm }) => {
  return (
    <div className="relative xs:mx-5 md:mx-0 p-4 rounded-2xl bg-white shadow-[0_20px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_30px_80px_rgba(0,0,0,0.5)] transition-all duration-300 md:w-full">
      {/* Icon Section */}
      <div className="flex items-start space-x-6 overflow-visible">
        <div className="flex-shrink-0 overflow-visible">
          <div className="bg-beige rounded-lg md:rounded-2xl p-2 md:p-4 shadow-[2px_2px_0_black] transform hover:scale-110 hover:rotate-3 transition-transform duration-300">
        ...
        <div className="flex-grow min-w-0">
          <h2 className="text-xl md:text-2xl font-extrabold text-maroon mb-3 tracking-tight truncate">
            {title}
          </h2>
          <p className="text-gray mb-3 md:mb-6 flex items-center">
          ...
          <div className="flex flex-wrap gap-1 md:gap-4">
            <p className="flex items-center text-gray bg-gradient-to-r from-green-50 to-green-100 py-1 px-2 md:py-3 md:px-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
              <DollarSign className="mr-3 text-green-600" size={22} />
              <span className="font-semibold">{salary}</span>
            </p>
            <p className="flex items-center text-gray-700 bg-gradient-to-r from-blue-50 to-blue-100 py-1 px-2 md:py-3 md:px-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
