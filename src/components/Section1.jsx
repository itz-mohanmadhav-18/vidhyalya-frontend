...
const Section1 = () => {
  return (
    <div className="relative h-screen overflow-hidden">
        ...
        <svg className="opacity-1 absolute -bottom-10 -z-10"
          style={{ filter: 'drop-shadow(0px -10px 0px rgba(255,255,255,0.75)) drop-shadow(0px -25px 0px rgba(255,255,255,0.5))' 
                }}
