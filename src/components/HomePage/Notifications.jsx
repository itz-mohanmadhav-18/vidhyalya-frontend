...
const NotificationBoard = () => {
  ...
  return (
    <>
      ...
      <div
        className="fixed hidden-scrollbar bottom-6 right-6 text-3xl cursor-pointer z-50 bg-black text-yellow-300 p-3 px-4 rounded-full shadow-xl hover:scale-110 transition-all duration-300 hover:bg-gray-900"
        onClick={toggleBoard}
      >
      ...
      {isVisible && (
        ...
        >
          ...
          >
            <h2
              className="text-3xl font-bold text-center mb-6 text-white hidden-scrollbar tracking-wider"
            ...
            <ul className="space-y-4 mt-4 hidden-scrollbar">
              {[
                ...
                <li
                  key={index}
                  className="flex items-center py-2 px-4 rounded-md hover:bg-gray-800 transition-colors duration-300"
                >
                  <span
